                ...
                script {
                    withCredentials([sshUserPrivateKey(credentialsId: 'ec2-user-ssh', keyFileVariable: 'KEYFILE'), string(credentialsId: 'vault-secret-text', variable: 'vault-password')]) {
                        sh '''
                            ...
                            ssh ec2-user@172.31.40.24 "rm -rf /home/ec2-user/nginx.conf" && ssh ec2-user@172.31.44.15 "rm -rf /home/ec2-user/nginx.conf" && ssh ec2-user@172.31.35.168 "rm -rf /home/ec2-user/nginx.conf"
                            ...
                            scp -r /var/lib/jenkins/workspace/app/Ansible/nginx.conf ec2-user@172.31.40.24:/home/ec2-user/ && scp -r /var/lib/jenkins/workspace/app/Ansible/web_conf_for_upstream/nginx.conf ec2-user@172.31.44.15:/home/ec2-user/ && scp -r /var/lib/jenkins/workspace/app/Ansible/web_conf_for_upstream/nginx.conf ec2-user@172.31.35.168:/home/ec2-user/
                            scp -r /var/lib/jenkins/workspace/app/Ansible/server.conf ec2-user@172.31.40.24:/home/ec2-user/ && scp -r /var/lib/jenkins/workspace/app/Ansible/web_conf_for_upstream/server.conf ec2-user@172.31.44.15:/home/ec2-user/ && scp -r /var/lib/jenkins/workspace/app/Ansible/web_conf_for_upstream/server.conf ec2-user@172.31.35.168:/home/ec2-user/
                            ssh ec2-user@172.31.40.24 "cp /home/ec2-user/nginx.conf /etc/nginx/nginx.conf" && ssh ec2-user@172.31.44.15 "cp /home/ec2-user/nginx.conf /etc/nginx/nginx.conf" && ssh ec2-user@172.31.35.168 "cp /home/ec2-user/nginx.conf /etc/nginx/nginx.conf"
